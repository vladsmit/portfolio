...
- Аналог игры "100 к 1"
- В игру может играть 2 игрока
- 4 раунда с повышением начисления очков
- Суперигра для победителя первых 4-х раундов
- SPA, созданный при помощи React, Mobx, Tailwind CSS и TypeScript;

Крестики-нолики:

- Классическая игра с расширинными возможностями
- Размер поля настраивается от 3х3 до 10х10
- Можно задавать имя игрокам
- Счёт побед ведется автоматически
- SPA, созданный при помощи React, ReduxToolKit и TypeScript;
